...
Также прочитали статью о conditioning и залезли в их репозиторий, попытались запустить, осознали, что там есть токенизация только для английского, поэтому сделали собственную токенизацию. 
